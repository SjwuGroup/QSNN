...
"""
It is the code used to train the classical neural network to complete the sentence recognition task.
The training result is shown in section III. A.
...
# label
y_no_list = [1]    # the index of the sequences labeled no
y_yes_list = [0]   # the index of the sequences labeled yes
...
def training_test_for_sample(sam):
    """
    training process beginning with a initialization sample
...
"""
Train with all initialization samples
"""
...
for i in result:
    loss_list_for_sample_list.append(i)


"""
Give the result the training
"""

# loss
Loss = open('sentence_recognition_classicalNN_loss.txt', mode='w')
